...
class _AddRestaurantPageState extends ConsumerState<AddRestaurantPage> {
  ...
  static const List<String> _cuines = [
    'Indian', 'North Indian', 'South Indian', 'Gujarati', 'Punjabi',
    'Maharashtrian', 'Rajasthani', 'Chinese', 'Italian', 'Mexican',
    'Thai', 'Japanese', 'Korean', 'Vietnamese', 'Mediterranean',
    'Lebanese', 'Turkish', 'Continental', 'American', 'Fast Food',
    'Street Food', 'Café', 'Bakery', 'Pizza', 'Burger', 'Seafood',
    'BBQ', 'Mughlai', 'Biryani', 'Desserts', 'Ice Cream', 'Vegan',
    'Vegetarian', 'Healthy', 'Multi Cuisine', 'Other'
  ];
  ...
  /// Show the searchable cuisines selector sheet
  Future<void> _showCuisineSelector() async {
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: const InputDecoration(
                            ...
                            hintText: 'Describe details, dishes, or experience...',
                          ),
                        ),
                        AppSizes.gapH16,

                        // Searchable Cuisine Input
                        InkWell(
                    ...
                    _buildSectionCard(
                      ...
                      children: [
                        Wrap(
                          ...
                          runSpacing: 12,
                          children: [
                            _buildBudgetChip('Budget Friendly', Colors.green),
                            _buildBudgetChip('Moderate', Colors.blue),
                            _buildBudgetChip('Premium', Colors.orange),
                    ...
                    _buildSectionCard(
                      ...
                      children: [
                        SwitchListTile(
                          ...
                          subtitle: Text('Save as a place you want to visit.', style: AppTypography.caption),
                          value: _isWishlist,
                        ...
                        SwitchListTile(
                          ...
                          subtitle: Text('Mark if you have already eaten here.', style: AppTypography.caption),
                          value: _isVisited,
